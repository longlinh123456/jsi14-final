		...
		return (<>
			<div>
				<div className="flex flex-col bg-red-300">
					<Navbar title="Trang chủ" links={navbarLinks} />
					<div className="text-center tracking-widest">
						<p className="mt-16 text-3xl font-medium text-textyellow">CÁC BƯỚC ĐỂ NHẬN</p>
						<p className="mt-4 text-5xl font-semibold text-red-600">THIỆP CHÚC TẾT</p>
						<br></br>
						<hr className="m-auto h-px max-w-4xl border-0 bg-gray-200 dark:bg-black"></hr>
					</div>
					<div className="mx-auto w-4/5">
						...
						<br></br>
						<img className="mx-auto w-4/6 rounded-2xl border-1 border-black" src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.15752-9/331103554_1225341004748904_3915740838392289158_n.png?_nc_cat=107&ccb=1-7&_nc_sid=ae9488&_nc_ohc=lh96cs23UP8AX88NtIc&_nc_oc=AQlEuFKFKvtlYFV8UlZPzhjdFSzK_yb1oLasYM4GYYAy4f9kp6RpQRV5KAQWm0_L-ko&_nc_ht=scontent-sin6-1.xx&oh=03_AdTl6YsSUcbvidxuHxMInaa4i3lQqJeM0n_1W0zquYRvDQ&oe=64130D6C"></img>
						<br></br>
						<img className="mx-auto w-4/6 rounded-2xl border-1 border-black" src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.15752-9/331156667_6287175928005469_417759695961086300_n.png?_nc_cat=111&ccb=1-7&_nc_sid=ae9488&_nc_ohc=3UONN7gBOZgAX_Px6VQ&tn=KHkTtSalEX58tRRD&_nc_ht=scontent-sin6-1.xx&oh=03_AdREmB49vacpL0YZVb6c_rWTL8fcNw63W-xBxjmYIo8BsA&oe=641310FA"></img>
						<br></br><br></br>
						...
						<br></br>
						<img className="mx-auto w-4/6 rounded-2xl border-1 border-black" src="https://scontent-sin6-3.xx.fbcdn.net/v/t1.15752-9/331169006_1132923977402938_7070325821761717989_n.png?_nc_cat=106&ccb=1-7&_nc_sid=ae9488&_nc_ohc=buNBoRs4J5AAX-hDeRF&_nc_ht=scontent-sin6-3.xx&oh=03_AdQJqyDumQzd2ZtZ9xgw_ORtzO3rDpMJ9cxVcq7DF436Xg&oe=6412FEAD"></img>
						<br></br><br></br>
						...
						<br></br>
						<img className="mx-auto w-4/6 rounded-2xl border-1 border-black" src="https://scontent.fhan5-1.fna.fbcdn.net/v/t1.15752-9/331226441_564760775715578_4625775485136862666_n.png?_nc_cat=100&ccb=1-7&_nc_sid=ae9488&_nc_ohc=7RuVkVftaYgAX9SgJaT&_nc_oc=AQnXj42-zdTJaS_K7eW6xTnvUspx8HLUf6l9WGRQAz1VnIRri3oHAVBF1weY2HQXY9U&_nc_ht=scontent.fhan5-1.fna&oh=03_AdRHRrDRtd1Svm2y-R2HvBdxT2I4Y7adGIeZUgmfvWtmzQ&oe=64131923"></img>
						<br></br><br></br>
						...
						<br></br>
						<img className="mx-auto w-4/6 rounded-2xl border-1 border-black" src="https://scontent.fhan5-9.fna.fbcdn.net/v/t1.15752-9/330660726_3548118775421366_3585495675821649332_n.png?_nc_cat=109&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeHcw4F6qHFFZH7o1KWmU7Ur2n7LJxJ5RwXafssnEnlHBUxWwF_Sxrm-u4WN9jlmU-E-3M-AF39n0AUKwWGXLer0&_nc_ohc=nFWHH5S6NfcAX-D6g3M&_nc_ht=scontent.fhan5-9.fna&oh=03_AdR0m2hcSHugoBsMgUwEaWdhaVH-Fs2DRxUTRqa9fjT2SQ&oe=6411CC9D"></img>
						<br></br><br></br><br></br>
					</div>
				</div>
			</div>
			<footer className="border-t-1 border-black bg-white p-4 sm:p-6 dark:bg-red-500">
				<div className="md:flex md:justify-between">
					<div className="mb-6 md:mb-0">
						<a href="#" className="flex items-center">
							<img src="https://media-public.canva.com/rEYeM/MAFS1MrEYeM/1/tl.png" className="mr-3 h-8" alt="Cat Logo" />
							<span className="self-center whitespace-nowrap text-2xl font-semibold dark:text-textyellow">Lời chúc tết</span>
						</a>
					</div>
					<div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
						<div>
							<h2 className="mb-6 text-sm font-semibold dark:text-textyellow">Resources</h2>
							<ul className="dark:text-white">
								<li className="mb-4">
									<a href="#" className="hover:underline">LT</a>
								</li>
								<li>
						...
						<div>
							<h2 className="mb-6 text-sm font-semibold  dark:text-textyellow">Legal</h2>
							<ul className=" dark:text-white">
								<li className="mb-4">
				...
				<hr className="my-6 border-gray-200 sm:mx-auto lg:my-8 dark:border-black" />
				<div className="sm:flex sm:items-center sm:justify-between">
					<span className=" dark:text-textyellow">© 2023 <a href="#" className="hover:underline">LT™</a>. All Rights Reserved.
					</span>
					<div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
						...
						<a href="#" className="text-black-500 ">
